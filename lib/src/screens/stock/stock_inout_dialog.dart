...
Future<StockInOutResult?> showStockInOutDialog(
  ...
  String enteredUnit =
      isIn ? (unitInHint ?? itemUnit) : (unitOutHint ?? itemUnit);
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      labelText:
                          isIn ? ctx.t.label_in_qty : ctx.t.label_out_qty,
                      hintText: '예: 3',
                    ),
                    validator: (v) {
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    decoration: InputDecoration(
                      labelText:
                          isIn ? ctx.t.label_in_unit : ctx.t.label_out_unit,
                    ),
                    onChanged: (v) {
                      if (v == null) return;
                      enteredUnit = v;
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      labelText:
                          ctx.t.label_conversion_rate(enteredUnit, targetUnit),
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      if (currentQtyHint !=
                          null) // ✅ 이 위치가 중요함: children 리스트 안에서만 가능
                        Text(
